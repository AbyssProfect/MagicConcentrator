...
{       	
	...
	glVertex3d(-l, l, -14);//передняя стенка по игрику
	...
	glVertex3d(-l, -l, -14);//задняя стенка по игрику
	...
	glNormal3d(0, 0, 1);
	glVertex3d(-l, l, -14);//задняя стенка по зет
	glVertex3d(l, l, -14);
	glVertex3d(l, -l, -14);
	glVertex3d(-l, -l, -14);
